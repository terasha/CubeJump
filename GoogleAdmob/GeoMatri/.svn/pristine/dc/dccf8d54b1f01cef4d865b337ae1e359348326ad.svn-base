...
namespace NNest.GeometryJump
{
	public class GameManager : MonoBehaviorHelper 
	{
		...
		public int diamond
		{
			get
			{
                int l = dataManager.Data.Diamond.GetCount();

				if(l <0)
				{
					l = 0;
                    dataManager.Data.Diamond.SetCount(l);
			...
			set
			{
                dataManager.Data.Diamond.SetCount(value);
                dataManager.DataSave();
                if (OnSetDiamond!=null)
					OnSetDiamond(value);
			}
		...
		private void Awake()
		{
            LoginManager.instnace.InitializeGPGS();
            dataManager.Init();
            this.SCORE = dataManager.Data.score;
            this.LIFE = dataManager.Data.Life;
            this.DIAMOND = dataManager.Data.Diamond;

            ADMobManager.instnace.StartInit();
            GPGS_Manager.instnace.StartInit();
